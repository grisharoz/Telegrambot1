# -*- coding: utf-8 -*-
import random
from lisruletki_object2 import list_of_roulette
...
if start=="да":
    ...
    while True:
        ...
        bet=input("Выбери из переченя:'число','красное/чёрное','старшинство','ряд,'совокупность','столбец','последовательность ',чётное/нечётное':")


        options = ["число", "красное/чёрное", "старшинство", "ряд", "совокупность", "столбец", "последовательность", "чётное/нечётное"]
        ...
        if again == 'да':
            ...
            if list_of_roulette[rand][bet]==choice:
                money +=1
